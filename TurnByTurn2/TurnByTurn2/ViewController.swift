...
class ViewController: UIViewController {
    ...
    @IBAction func startBtn(_ sender: UIButton) { showDirections() }
    ...
    func destination() -> MKMapItem {
        let destinationCoordinate = CLLocationCoordinate2D(latitude: 37.7879, longitude: -122.4102) //The Donatello hotel San Francisco coordinates
        
        //Create annotation for destination
        let destinationAnnotation = Annotation(coordinate: destinationCoordinate, title: "Safe Place", subtitle: "bla bla")
